...
ระบบจัดการคำขอ "เบิก/คืน" อุปกรณ์ IT โดยใช้ Vue (หน้าเว็บแอดมิน) + n8n (Automation) + Google Sheets (ฐานข้อมูลจาก Google Form)

## ภาพรวมการทำงาน

1. ผู้ใช้กรอกข้อมูลผ่าน Google Form (ผู้ใช้ไม่เข้าเว็บนี้)
